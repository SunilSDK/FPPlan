...
data class MEMPLOYEEPLANT(
    ...
    override fun toString(): String {
        return "MEMPLOYEEPLANT(cAPICITY=$cAPICITY, cOMPANYCODE='$cOMPANYCODE', cONTACTNO1='$cONTACTNO1', cONTACTNO2='$cONTACTNO2', cORPORATEADDR='$cORPORATEADDR', cREATEDBY='$cREATEDBY', cREATEDDATE='$cREATEDDATE', eMAILADDR='$eMAILADDR', eMPLOYEEID=$eMPLOYEEID, fAXNO='$fAXNO', iSDELETED=$iSDELETED, mODIFIEDBY=$mODIFIEDBY, mODIFIEDDATE=$mODIFIEDDATE, pLANTCODE='$pLANTCODE', pLANTHEAD='$pLANTHEAD', pLANTHEADEMAILADDR='$pLANTHEADEMAILADDR', pLANTNAME='$pLANTNAME', rEGISTEREDADDR='$rEGISTEREDADDR')"
    }
}