...
data class ViewOrderInvoiceDetail(
    ...
    override fun toString(): String {
        return "ViewOrderInvoiceDetail(bILLINGITEM='$bILLINGITEM', bILLINGTYPE='$bILLINGTYPE', cITY='$cITY', cREATEDON='$cREATEDON', cUSTOMERCODE='$cUSTOMERCODE', cUSTOMERNAME='$cUSTOMERNAME', mATERIALCODE='$mATERIALCODE', mATERIALNAME='$mATERIALNAME', oPENQTY=$oPENQTY, oRDERDATETIME='$oRDERDATETIME', oRDERDOC=$oRDERDOC, oRDERNO='$oRDERNO', oRDERTIME='$oRDERTIME', oUTBOUNDNO='$oUTBOUNDNO', pLANTCODE='$pLANTCODE', qTY=$qTY, rEGION='$rEGION', sALEINVOICEDATE='$sALEINVOICEDATE', sALEINVOICENO='$sALEINVOICENO', sALESQTY=$sALESQTY, sTATUS='$sTATUS', uNIT='$uNIT')"
    }
}