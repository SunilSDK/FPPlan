...
data class ViewOrderDispatchDone(
    ...
    override fun toString(): String {
        return "ViewOrderDispatchDone(oRDERDATETIME='$oRDERDATETIME', oRDERNO='$oRDERNO', orderQTY=$orderQTY, sALEINVOICEDATE='$sALEINVOICEDATE', sALEINVOICENO='$sALEINVOICENO', salesQTY=$salesQTY)"
    }
}